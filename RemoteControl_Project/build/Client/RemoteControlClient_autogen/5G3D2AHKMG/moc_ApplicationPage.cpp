...
#include "../../../../Client/Pages/ApplicationPage.h"
...
template <> constexpr inline auto ApplicationPage::qt_create_metaobjectdata<qt_meta_tag_ZN15ApplicationPageE_t>()
{
    ...
    return QtMocHelpers::metaObjectData<ApplicationPage, qt_meta_tag_ZN15ApplicationPageE_t>(QMC::MetaObjectFlag{}, qt_stringData,
            qt_methods, qt_properties, qt_enums);
}
Q_CONSTINIT const QMetaObject ApplicationPage::staticMetaObject = { {
    QMetaObject::SuperData::link<QWidget::staticMetaObject>(),
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN15ApplicationPageE_t>.stringdata,
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN15ApplicationPageE_t>.data,
    qt_static_metacall,
    nullptr,
    qt_staticMetaObjectRelocatingContent<qt_meta_tag_ZN15ApplicationPageE_t>.metaTypes,
    nullptr
} };
...
void *ApplicationPage::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_staticMetaObjectStaticContent<qt_meta_tag_ZN15ApplicationPageE_t>.strings))

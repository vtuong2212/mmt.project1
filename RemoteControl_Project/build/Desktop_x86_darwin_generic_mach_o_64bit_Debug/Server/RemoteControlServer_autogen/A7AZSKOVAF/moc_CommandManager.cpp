...
template <> constexpr inline auto CommandManager::qt_create_metaobjectdata<qt_meta_tag_ZN14CommandManagerE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        ...
        // Slot 'handleCommand'
        QtMocHelpers::SlotData<void(const Packet &)>(5, 2, QMC::AccessPublic, QMetaType::Void, {{
            { 0x80000000 | 3, 4 },
        }}),
    };
...
void CommandManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->responseReady((*reinterpret_cast<std::add_pointer_t<Packet>>(_a[1]))); break;
        case 1: _t->handleCommand((*reinterpret_cast<std::add_pointer_t<Packet>>(_a[1]))); break;
        default: ;
        }
    }
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (CommandManager::*)(const Packet & )>(_a, &CommandManager::responseReady, 0))
            return;
    }
}
...
// SIGNAL 0
void CommandManager::responseReady(const Packet & _t1)
{
